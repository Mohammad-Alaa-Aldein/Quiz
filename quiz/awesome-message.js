...
// Add your code here
	...
	let awseomeMessage=("Hi, My name is " + firstName + ". I love " + interest +. "In my spare time, I like to " + hobby);
	console.log(awseomeMessage);
	...
	let awseomeMessage=("Hi, My name is " + firstName2 +". I love" + interest2 + ". In my spare time, I like to " + hobby2);
	console.log(awseomeMessage);